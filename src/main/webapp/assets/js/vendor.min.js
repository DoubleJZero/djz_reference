...
function fn_leftMenuInit(){$("#mobile-collapse").click(function(){-1!=$(".pcoded-navbar").attr("class").indexOf("navbar-collapsed")?$(".pcoded-hasmenu").each(function(e,t){-1!=$(this).attr("class").indexOf("active")&&$(this).removeClass("pcoded-trigger")}):$(".pcoded-hasmenu").each(function(e,t){-1!=$(this).attr("class").indexOf("active")&&$(this).addClass("pcoded-trigger")})})}function fn_isCheckValueVaild(e){return void 0!==e&&null!=e&&""!=e.trim()}function fn_isCheckNumValueVaild(e){return void 0!==e&&null!=e}function fn_createFormSubmit(e,t,a,i,n,l){var c=document.createElement("form"),o=document.createElement("input");if(c.setAttribute("method",t),c.setAttribute("action",e),fn_isCheckValueVaild(a)&&c.setAttribute("target",a),fn_isCheckNumValueVaild(l)&&1!=l)for(var s=i.split(","),u=n.split(","),r=0;r<l;r++)s[r]&&((o=document.createElement("input")).type="hidden",o.name=s[r],o.value=fn_changeText(u[r]),c.appendChild(o));else fn_isCheckValueVaild(i)&&(o.type="hidden",o.name=i,o.value=n,c.appendChild(o));document.body.appendChild(c),c.submit()}function fn_changeHtml(e){return fn_isCheckNumValueVaild(e)?e=e.replace(/&lt;/gi,"<").replace(/&gt;/gi,">").replace(/&apos;/gi,"'"):""}function fn_changeText(e){return fn_isCheckNumValueVaild(e)?e=e.replace(/</gi,"&lt;").replace(/>/gi,"&gt;").replace(/\'/gi,"&apos;"):""}function fn_getYmdToday(){var e=new Date,t=e.getFullYear(),a=new String(e.getMonth()+1),e=new String(e.getDate());return 1==a.length&&(a="0"+a),1==e.length&&(e="0"+e),t+a+e}function fn_changeLang(e){$.ajax({url:"/changeLang.do",type:"POST",data:{lang:e},dataType:"text",success:function(e){"success"==e&&location.reload()},error:function(e,t,a){alert("status: "+e.status+", error: "+a)}})}function fn_isEmailValid(e){if(!fn_isCheckValueVaild(e))return console.log("이메일 값이 유효하지 않음"),!1;return null!=e.match(/^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]{2,3}$/i)||(console.log("이메일 형식에 맞게 입력해주세요."),!1)}function fn_isPhoneNumber(e){if(!fn_isCheckNumValueVaild(e)&&""==e)return console.log("전화번호 값이 유효하지 않음"),!1;e=new String(e);if(e.length<11)return console.log("전화번호를 올바르게 입력해주세요. \n최소 길이가 11 이상입니다."),!1;if(0<parseInt(e.substring(0,1)))return console.log("전화번호를 올바르게 입력해주세요. \n첫번째 자리가 1 이상으로 시작할 수 없습니다."),!1;if(7<parseInt(e.substring(1,2)))return console.log("전화번호를 올바르게 입력해주세요. \n두번째 자리가 8 이상으로 시작할 수 없습니다."),!1;if("01"==e.substring(0,2)){if(e.length<12)return console.log("전화번호를 올바르게 입력해주세요. \n최소 길이가 12 이상입니다."),!1}else if("02"==e.substring(0,2)){if(e.length<11&&12<e.length)return console.log("전화번호를 올바르게 입력해주세요. \n길이가 11 또는 12이여야 합니다."),!1}else if("03"==e.substring(0,2)){if(e.length<12)return console.log("전화번호를 올바르게 입력해주세요. \n최소 길이가 12 이상입니다."),!1;if(3<parseInt(e.substring(2,3)))return console.log("전화번호를 올바르게 입력해주세요. \n지역번호를 다시 확인 바랍니다."),!1}else if("04"==e.substring(0,2)){if(e.length<12)return console.log("전화번호를 올바르게 입력해주세요. \n최소 길이가 12 이상입니다."),!1;if(4<parseInt(e.substring(2,3)))return console.log("전화번호를 올바르게 입력해주세요. \n지역번호를 다시 확인 바랍니다."),!1}else if("05"==e.substring(0,2)){if(e.length<12)return console.log("전화번호를 올바르게 입력해주세요. \n최소 길이가 12 이상입니다."),!1;if(5<parseInt(e.substring(2,3)))return console.log("전화번호를 올바르게 입력해주세요. \n지역번호를 다시 확인 바랍니다."),!1}else if("06"==e.substring(0,2)){if(e.length<12)return console.log("전화번호를 올바르게 입력해주세요. \n최소 길이가 12 이상입니다."),!1;if(4<parseInt(e.substring(2,3)))return console.log("전화번호를 올바르게 입력해주세요. \n지역번호를 다시 확인 바랍니다."),!1}else if("07"==e.substring(0,2)){if(e.length<12)return console.log("전화번호를 올바르게 입력해주세요. \n최소 길이가 12 이상입니다."),!1;if(1<parseInt(e.substring(2,3)))return console.log("전화번호를 올바르게 입력해주세요. \n첫번째 자리가 1 이상으로 시작할 수 없습니다."),!1}return!0}function fn_checkId(e){return 0!=(e=new String(e)).trim().length&&!(e.length<6||16<e.length)}function fn_checkPassword1(e){return 0!=(e=new String(e)).trim().length&&!(e.length<9||20<e.length)}function fn_checkPassword2(e){return!!(/[0-9]/.test(e)&&/[a-zA-Z]/.test(e)&&/[~!@#$%^&*()_+|<>?:{}]/.test(e))}function fn_isPrime(e){if(!fn_isCheckNumValueVaild(e)||""==e)return!1;if(isNaN(e))return!1;var t=[999999001,999999017,999999029,999999043,999999059,999999067,999999103,999999107,999999113,999999131,999999137,999999151,999999163,999999181,999999191,999999193,999999197,999999223,999999229,999999323,999999337,999999353,999999391,999999433,999999487,999999491,999999503,999999527,999999541,999999587,999999599,999999607,999999613,999999667,999999677,999999733,999999739,999999751,999999757,999999761,999999797,999999883,999999893,999999929,999999937];if((e=parseInt(e))<t[0]&&t[t.length-1]<e)return!1;for(var a=0;a<t.length;a++)if(t[a]==e)return!0;return!1}function fn_serialize(){var e=$("input,select,textarea"),o='{"';return $(e).each(function(e,t){var a,i,n,l,c=t.tagName.toLowerCase();"input"==c?"checkbox"==(a=$(t).attr("type").toLowerCase())?(i=t.name,l="",-1==o.indexOf(i)&&("userGroup"==i?$("input:checkbox[name=userGroup]:checked").each(function(){l+=$(this).val()+":"}):$("input:checkbox[name="+i+"]:checked").each(function(){l+=$(this).val()+","}),fn_isCheckValueVaild(l)&&(l=l.substring(0,l.length-1)),o+=i+'":"',o+=l+'","')):"radio"==a?(i=t.name,l="",$("input:radio[name="+i+"]:checked").each(function(){l+=$(this).val()+","}),fn_isCheckValueVaild(l)&&(l=l.substring(0,l.length-1)),o+=i+'":"',o+=l+'","'):(n=t.id,fn_isCheckValueVaild(l=$(t).val())&&(o+=n+'":"',o+=l+'","')):"select"!=c&&"textarea"!=c||(n=t.id,fn_isCheckValueVaild(l=$(t).val())&&(o+=n+'":"',o+=l+'","'))}),o=o.substring(0,o.length-2),o+="}",o=JSON.parse(o)}function MultiSelector(e,t){this.list_target=e,this.count=0,this.id=0,this.update_count=0,this.max=void 0===t||null==t?5:t,this.current_count=0,this.maxFileSize=73400320,(_base=this).addElement=function(a){"INPUT"==a.tagName&&"file"==a.type?(a.name="file_"+this.id,a.id="file_"+this.id,$("#fileUploaderLabel").attr("for",a.id),a.style.display="none",this.id++,a.multi_selector=this,a.onchange=function(){if(fn_isBrowserIE()){if(new ActiveXObject("Scripting.FileSystemObject").getFile(a.value).size>_base.maxFileSize)return swal("첨부파일 사이즈는 70MB 이내로 등록 가능합니다."),void(a.value="")}else if(a.files[0].size>_base.maxFileSize)return swal("첨부파일 사이즈는 70MB 이내로 등록 가능합니다."),void(a.value="");var e="첨부파일 갯수는 ["+(_base.max+1)+"]이상 첨부할 수 없습니다.";if(0<_base.update_count&&_base.count>_base.max-_base.update_count)return a.value="",void swal(e);if(0<_base.max&&_base.count>_base.max)return a.value="",void swal(e);for(var t=0;t<_base.count-1;t++)if($("#file_"+t).val()==a.value)return swal("중복파일이 있습니다. 확인 후 다시 등록 바랍니다."),void(a.value="");e=document.createElement("input");e.type="file",e.style.display="none",this.parentNode.insertBefore(e,this),this.multi_selector.addElement(e),this.multi_selector.addListRowNew(this),this.style.position="absolute",this.style.left="-1000px",this.style.top="-1000px",this.style.display="none",this.style.visibility="hidden",this.style.width="0",this.style.height="0",this.style.overflow="hidden",e.onkeypress=function(){return!1}},this.count++,this.current_element=a):swal("Error: not a file input element")},this.addListRowNew=function(e){var t=document.createElement("div");t.className="file_add";var a=document.createElement("input");a.type="button",a.value="delete",a.setAttribute("style","margin: 1px; padding: 3px;"),t.element=e,a.onclick=function(){return this.parentNode.element.parentNode.removeChild(this.parentNode.element),this.parentNode.parentNode.removeChild(this.parentNode),this.parentNode.element.multi_selector.count--,this.parentNode.element.multi_selector.current_element.disabled=!1};e=(e=e.value).substring(e.lastIndexOf("\\")+1);t.innerHTML="<span>"+e+"</span>&nbsp;&nbsp;",t.appendChild(a),this.list_target.appendChild(t)}}function fn_fileUploaderLabelClick(){$("#fileUploaderLabel").click()}function fn_fileDown(e){window.open("/fileDown.do?atchflId="+e,"hiddenFrame")}function fn_deleteFile(t,a){swal({title:"파일삭제",text:"삭제하시겠습니까?",icon:"warning",buttons:!0,dangerMode:!0}).then(e=>{e&&$.ajax({type:"POST",url:"/deleteFileInfo.do",data:{atchflId:t},dataType:"text",success:function(e){"success"==e&&$("#"+a).remove()},error:function(e,t,a){alert("status: "+e.status+", error: "+a)}})})}function fn_updateFileInfoAjax(i,e,n){$.ajax({type:"POST",url:"/getFileInfoAjax.do",data:{atchflGrpId:e},async:!1,dataType:"json",success:function(e){var t,a;fn_isCheckNumValueVaild(e)&&(a='<table id="fileViewTable" style="border:0px solid #666;">',t=$("#"+i),$.each(e,function(e,t){a+='<tr id="fileViewTableTr_'+(e+1)+'" class="custViewFile"><td style="border:0px solid #666;text-align:left;padding:0 0 0 0;margin:0 0 0 0;" height="22"><a href="javascript:fn_fileDown(\''+t.atchflId+'\');" class="link orgfcnt" target="_self">'+t.atchflNm+"."+t.atchflExtnsnNm+'</a><img src="/assets/images/file_close.png" class="cursor" onClick="fn_deleteFile(\''+t.atchflId+"','fileViewTableTr_"+(e+1)+'\');" alt="delete" style="margin-top:2px; margin-left:2px;"/><iframe width=0 height=0 name="hiddenFrame" style="display:none;"></iframe></td></tr>'}),a+="</table>",t.empty(),t.html(a),fn_isCheckValueVaild(n)&&(a='<input type="text" class="upload_namefile form-control" value="파일을 선택하세요." readonly="readonly" onclick="fn_fileUploaderLabelClick()" />',a+='<div class="input-group-append">',a+='<button class="btn btn-primary" type="button" onclick="fn_fileUploaderLabelClick()">파일선택</button>',a+="</div>",a+='<label id="fileUploaderLabel" for="fileUploader" class="file_box_label"></label>',a+='<input name="file_1" id="fileUploader" type="file" />',$("#"+n).empty(),$("#"+n).html(a),new MultiSelector(document.getElementById("fileList"),1).addElement(document.getElementById("fileUploader"))),$("#fileList").empty())},error:function(e,t,a){alert("status: "+e.status+", error: "+a)}})}function fn_getFileInfoAjax(i,e){$.ajax({type:"POST",url:"/getFileInfoAjax.do",data:{atchflGrpId:e},async:!1,dataType:"json",success:function(e){var a,t;fn_isCheckNumValueVaild(e)&&(a="",t=$("#"+i),$.each(e,function(e,t){a+="<a href=\"javascript:fn_fileDown('"+t.atchflId+'\');" class="link custViewFile" target="_self"><img src="/assets/images/file.gif" class="cursor" alt="file" />'+t.atchflNm+"."+t.atchflExtnsnNm+'</a><iframe width=0 height=0 name="hiddenFrame" style="display:none;"></iframe>'}),t.empty(),t.html(a))},error:function(e,t,a){alert("status: "+e.status+", error: "+a)}})}function fn_isBrowserIE(){return"Microsoft Internet Explorer"==navigator.appName}function fn_checkByteForFile(e){for(var t,a=e.length,i=0,n=0;n<a;n++)t=e.charAt(n),4<escape(t).length?i+=2:i++,i<=100&&0;return!(100<i)||(swal("파일명은 최대 100byte를 초과할 수 없습니다."),!1)}function fn_isMaximumOverFileCnt(e,t){return e<$(".orgfcnt").length+$(".file_add").length&&(fn_isCheckValueVaild(t)&&(e='<input type="text" class="upload_namefile form-control" value="파일을 선택하세요." readonly="readonly" onclick="fn_fileUploaderLabelClick()" />',e+='<div class="input-group-append">',e+='<button class="btn btn-primary" type="button" onclick="fn_fileUploaderLabelClick()">파일선택</button>',e+="</div>",e+='<label id="fileUploaderLabel" for="fileUploader" class="file_box_label"></label>',e+='<input name="file_1" id="fileUploader" type="file" />',$("#"+t).empty(),$("#"+t).html('<input type="text" class="upload_namefile form-control" value="파일을 선택하세요." readonly="readonly" onclick="fn_fileUploaderLabelClick()" /><div class="input-group-append"><button class="btn btn-primary" type="button" onclick="fn_fileUploaderLabelClick()">파일선택</button></div><label id="fileUploaderLabel" for="fileUploader" class="file_box_label"></label><input name="file_1" id="fileUploader" type="file" />'),new MultiSelector(document.getElementById("fileList"),1).addElement(document.getElementById("fileUploader"))),$("#fileList").empty(),!0)}function fn_isMaximumOverFileCntSm9(e,t,a){var i=$(".orgfcnt").length,n=$(".file_add").length;return fn_isCheckValueVaild(a)||(a=""),e<i+n&&(fn_isCheckValueVaild(t)&&(a='<label class="col-form-label col-sm-3">'+a+"</label>",a+='<input type="text" class="upload_namefile form-control col-sm-9" value="파일을 선택하세요." readonly="readonly" onclick="fn_fileUploaderLabelClick()" />',a+='<div class="input-group-append">',a+='<button class="btn btn-primary" type="button" onclick="fn_fileUploaderLabelClick()">파일선택</button>',a+="</div>",a+='<label id="fileUploaderLabel" for="fileUploader" class="file_box_label"></label>',a+='<input name="file_1" id="fileUploader" type="file" />',$("#"+t).empty(),$("#"+t).html(a),new MultiSelector(document.getElementById("fileList"),1).addElement(document.getElementById("fileUploader"))),$("#fileList").empty(),!0)}function fn_isMaximumOverFileCntSm8(e,t,a){var i=$(".orgfcnt").length,n=$(".file_add").length;return fn_isCheckValueVaild(a)||(a=""),e<i+n&&(fn_isCheckValueVaild(t)&&(a='<label class="col-form-label col-sm-4">'+a+"</label>",a+='<input type="text" class="upload_namefile form-control col-sm-8" value="파일을 선택하세요." readonly="readonly" onclick="fn_fileUploaderLabelClick()" />',a+='<div class="input-group-append">',a+='<button class="btn btn-primary" type="button" onclick="fn_fileUploaderLabelClick()">파일선택</button>',a+="</div>",a+='<label id="fileUploaderLabel" for="fileUploader" class="file_box_label"></label>',a+='<input name="file_1" id="fileUploader" type="file" />',$("#"+t).empty(),$("#"+t).html(a),new MultiSelector(document.getElementById("fileList"),1).addElement(document.getElementById("fileUploader"))),$("#fileList").empty(),!0)}function fn_isMaximumOverFileCntSm6(e,t,a){var i=$(".orgfcnt").length,n=$(".file_add").length;return fn_isCheckValueVaild(a)||(a=""),e<i+n&&(fn_isCheckValueVaild(t)&&(a='<label class="col-form-label col-sm-6">'+a+"</label>",a+='<input type="text" class="upload_namefile form-control col-sm-6" value="파일을 선택하세요." readonly="readonly" onclick="fn_fileUploaderLabelClick()" />',a+='<div class="input-group-append">',a+='<button class="btn btn-primary" type="button" onclick="fn_fileUploaderLabelClick()">파일선택</button>',a+="</div>",a+='<label id="fileUploaderLabel" for="fileUploader" class="file_box_label"></label>',a+='<input name="file_1" id="fileUploader" type="file" />',$("#"+t).empty(),$("#"+t).html(a),new MultiSelector(document.getElementById("fileList"),1).addElement(document.getElementById("fileUploader"))),$("#fileList").empty(),!0)}function fn_initFile(e){fn_isCheckValueVaild(e)&&($("#"+e).empty(),$("#"+e).html('<input type="text" class="upload_namefile form-control" value="파일을 선택하세요." readonly="readonly" onclick="fn_fileUploaderLabelClick()" /><div class="input-group-append"><button class="btn btn-primary" type="button" onclick="fn_fileUploaderLabelClick()">파일선택</button></div><label id="fileUploaderLabel" for="fileUploader" class="file_box_label"></label><input name="file_1" id="fileUploader" type="file" />'),new MultiSelector(document.getElementById("fileList"),1).addElement(document.getElementById("fileUploader"))),$("#fileList").empty()}function fn_initFileSm9(e,t){fn_isCheckValueVaild(t)||(t=""),fn_isCheckValueVaild(e)&&(t='<label class="col-form-label col-sm-3">'+t+"</label>",t+='<input type="text" class="upload_namefile form-control col-sm-9" value="파일을 선택하세요." readonly="readonly" onclick="fn_fileUploaderLabelClick()" />',t+='<div class="input-group-append">',t+='<button class="btn btn-primary" type="button" onclick="fn_fileUploaderLabelClick()">파일선택</button>',t+="</div>",t+='<label id="fileUploaderLabel" for="fileUploader" class="file_box_label"></label>',t+='<input name="file_1" id="fileUploader" type="file" />',$("#"+e).empty(),$("#"+e).html(t),new MultiSelector(document.getElementById("fileList"),1).addElement(document.getElementById("fileUploader"))),$("#fileList").empty()}function fn_initFileSm8(e,t){fn_isCheckValueVaild(t)||(t=""),fn_isCheckValueVaild(e)&&(t='<label class="col-form-label col-sm-4">'+t+"</label>",t+='<input type="text" class="upload_namefile form-control col-sm-8" value="파일을 선택하세요." readonly="readonly" onclick="fn_fileUploaderLabelClick()" />',t+='<div class="input-group-append">',t+='<button class="btn btn-primary" type="button" onclick="fn_fileUploaderLabelClick()">파일선택</button>',t+="</div>",t+='<label id="fileUploaderLabel" for="fileUploader" class="file_box_label"></label>',t+='<input name="file_1" id="fileUploader" type="file" />',$("#"+e).empty(),$("#"+e).html(t),new MultiSelector(document.getElementById("fileList"),1).addElement(document.getElementById("fileUploader"))),$("#fileList").empty()}function fn_isNotSelectedFile(){return 0==$(".file_add").length}function fn_cPopup(e,t,a,i,n,l){fn_isCheckNumValueVaild(n)||""!=n||(n=680),fn_isCheckNumValueVaild(l)||""!=l||(l=570);var c,o=(screen.width-n)/2,s=(screen.height-l)/2,u=fn_getRstr();return fn_isCheckValueVaild(t)?(c=window.open("",u,"width="+n+",height="+l+",top="+s+",left="+o+", scrollbars=no"),fn_createFormSubmit(e,"post",u,t,a,i)):c=window.open(e,u,"width="+n+",height="+l+",top="+s+",left="+o+", scrollbars=no"),c&&c.focus(),c}function fn_getRstr(){for(var e="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz",t="",a=0;a<15;a++){var i=Math.floor(Math.random()*e.length);t+=e.substring(i,i+1)}return t}function fn_checkAll(e,t){$("#"+e).is(":checked")?$("input:checkbox[name='"+t+"']").each(function(e,t){0==$(this).is(":disabled")&&0==$(this).is(":checked")&&$(this).click()}):$("input:checkbox[name='"+t+"']").each(function(e,t){$(this).is(":checked")&&$(this).click()})}function fn_getCheckBoxValueYn(e){var a="";return $("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")&&0==$(this).is(":disabled")?a+="Y,":a+="N,"}),0!=a.length&&(a=a.substring(0,a.length-1)),a}function fn_getCheckBoxValueForName(e,t){var a="";return fn_isCheckNumValueVaild(t)&&""!=t?1==t?$("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}):2==t?$("input:checkbox[name='"+e+"']").each(function(e,t){a+=$(this).val()+","}):3==t?$("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")&&(a+=$(this).val()+",")}):$("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}):$("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}),0!=a.length&&(a=a.substring(0,a.length-1)),a}function fn_getCheckBoxValueForClass(e,t){var a="";return fn_isCheckNumValueVaild(t)&&""!=t?1==t?$("."+e).each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}):2==t?$("."+e).each(function(e,t){a+=$(this).val()+","}):3==t?$("."+e).each(function(e,t){$(this).is(":checked")&&(a+=$(this).val()+",")}):$("."+e).each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}):$("."+e).each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}),0!=a.length&&(a=a.substring(0,a.length-1)),a}function fn_getInputNameValue(e){var a="";return $("input[name='"+e+"']").each(function(e,t){a+=$(this).val()+","}),0!=a.length&&(a=a.substring(0,a.length-1)),a}function fn_getTdNameHtml(e){var a="";return $("td[name='"+e+"']").each(function(e,t){a+=$(this).html()+","}),0!=a.length&&(a=a.substring(0,a.length-1)),a}function fn_checkboxDisabledSettingForClass(e){$("."+e).click(function(e){var t=$(this).attr("id");$(this).is(":checked")?$("input:checkbox[name='"+t+"']").each(function(e,t){$(t).attr("disabled",!1)}):$("input:checkbox[name='"+t+"']").each(function(e,t){$(t).is(":checked")&&$(t).click(),$(t).attr("disabled",!0)})})}function fn_inputPhoneNumber(e){var t=e.value.replace(/[^0-9]/g,""),a="";if(t.length<4)return t;t.length<7?(a+=t.substr(0,3),a+="-",a+=t.substr(3)):t.length<11?(a+=t.substr(0,3),a+="-",a+=t.substr(3,3),a+="-",a+=t.substr(6)):(a+=t.substr(0,3),a+="-",a+=t.substr(3,4),a+="-",a+=t.substr(7)),e.value=a}function fn_isMobileValid(e){return!!/^(01[016789]{1}|02|0[3-9]{1}[0-9]{1})-?[0-9]{3,4}-?[0-9]{4}$/.test(e)||(console.log("전화번호(휴대폰) 유효하지 않음."),!1)}function fn_isTelValid(e){var t=new String(e);if(8!=(t=t.replace(/-/gi,"")).length){console.log(t.length);if(!/^(01[016789]{1}|02|0[3-9]{1}[0-9]{1})-?[0-9]{3,4}-?[0-9]{4}$/.test(e))return console.log("전화번호(휴대폰) 유효하지 않음."),!1}return!0}function fn_getAddressPop(t,a){new daum.Postcode({oncomplete:function(e){document.getElementById(t).value=e.zonecode,document.getElementById(a).value=e.roadAddress}}).open()}function jqGridRowsData(gridId){var custtempval1="",custtempval2="",custtempval3="",custtempval4="",custtempval5="",custtempval6="",custtempval7="",custtempval8="",custtempval9="",custtempval10="",custtempval11="",custtempval12="",custtempval13="",custtempval14="",custtempval15="",custtempval16="",custtempval17="",custtempval18="",custtempval19="",custtempval20="",custtempval21="",custtempval22="",custtempval23="",custtempval24="",custtempval25="",custtempval26="",custtempval27="",custtempval28="",custtempval29="",custtempval30="",custtempval31="",custtempval32="",custtempval33="",custtempval34="",custtempval35="",custtempval36="",custtempval37="",custtempval38="",custtempval39="",custtempval40="",custtempval41="",custtempval42="",custtempval43="",custtempval44="",custtempval45="",custtempval46="",custtempval47="",custtempval48="",custtempval49="",custtempval50="",custtempval51="",custtempval52="",custtempval53="",custtempval54="",custtempval55="",custtempval56="",custtempval57="",custtempval58="",custtempval59="",rowIds=$("#"+gridId).jqGrid("getDataIDs");$.each(rowIds,function(e,t){$("#"+gridId).jqGrid("saveRow",t)});var data=$("#"+gridId).jqGrid("getRowData"),rowCnt=$("#"+gridId).jqGrid("getGridParam","records"),variables=new Array;0!=rowCnt&&$.each(data[0],function(e,t){variables.push(e+"s")}),$.each(data,function(index1,item1){var tcnt=0;$.each(item1,function(index2,item2){tcnt++,-1!=item2.indexOf("<",0)?eval("custtempval"+tcnt+' += ","'):eval("custtempval"+tcnt+' += "'+item2+',"')})});for(var i=1;i<=variables.length;i++)eval("custtempval"+i+"=custtempval"+i+".substring(0, custtempval"+i+".length-1)");for(var ret={},i=0;i<variables.length;i++)ret[variables[i]]=eval("custtempval"+(i+1));return ret}function fn_inputRestriction(){$(".custif").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=(t=(t=(t=t.replace(/[\ㄱ-ㅎㅏ-ㅣ|가-힣]/gi,"")).replace(/[~!@#$%^&*()_+|<>?:{}`=; .]/gi,"")).replace(/-/gi,"")).replace(/\//gi,""),$(this).val(t))}),$(".custif").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=(t=(t=(t=t.replace(/[\ㄱ-ㅎㅏ-ㅣ|가-힣]/gi,"")).replace(/[~!@#$%^&*()_+|<>?:{}`=; .]/gi,"")).replace(/-/gi,"")).replace(/\//gi,""),$(this).val(t))}),$(".custpf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=(t=t.replace(/[\ㄱ-ㅎㅏ-ㅣ|가-힣]/gi,"")).replace(/-/gi,""),$(this).val(t))}),$(".custpf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=(t=t.replace(/[\ㄱ-ㅎㅏ-ㅣ|가-힣]/gi,"")).replace(/-/gi,""),$(this).val(t))}),$(".custakf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[\ㄱ-ㅎㅏ-ㅣ|가-힣]/gi,""),$(this).val(t))}),$(".custakf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[\ㄱ-ㅎㅏ-ㅣ|가-힣]/gi,""),$(this).val(t))}),$(".custascf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[~!@#$%^&*()_+|<>?:{}]/gi,""),$(this).val(t))}),$(".custascf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[~!@#$%^&*()_+|<>?:{}]/gi,""),$(this).val(t))}),$(".custascffe").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[~!#$%^&*()_+|<>?:{}]/gi,""),$(this).val(t))}),$(".custascffe").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[~!#$%^&*()_+|<>?:{}]/gi,""),$(this).val(t))}),$(".custadf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/-/gi,""),$(this).val(t))}),$(".custadf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/-/gi,""),$(this).val(t))}),$(".custaef").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/=/gi,""),$(this).val(t))}),$(".custaef").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/=/gi,""),$(this).val(t))}),$(".custaenf").keyup(function(e){$(this).val($(this).val().replace(/[a-zA-Z]/g,""))}),$(".custaenf").focusout(function(e){$(this).val($(this).val().replace(/[a-zA-Z]/g,""))}),$(".custacf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[.]/gi,""),$(this).val(t))}),$(".custacf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[.]/gi,""),$(this).val(t))}),$(".custonf").keyup(function(e){$(this).val($(this).val().replace(/[^0-9]/g,""))}),$(".custonf").focusout(function(e){$(this).val($(this).val().replace(/[^0-9]/g,""))}),$(".custonpf").keyup(function(e){$(this).val($(this).val().replace(/[^0-9.]/g,""))}),$(".custonpf").focusout(function(e){$(this).val($(this).val().replace(/[^0-9.]/g,""))}),$(".custopnf").keyup(function(e){$(this).val($(this).val().replace(/[^0-9 -]/g,""))}),$(".custopnf").focusout(function(e){$(this).val($(this).val().replace(/[^0-9 -]/g,""))}),$(".custoef").keyup(function(e){$(this).val($(this).val().replace(/[^a-zA-Z]/g,""))}),$(".custoef").focusout(function(e){$(this).val($(this).val().replace(/[^a-zA-Z]/g,""))}),$(".custokf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣]/gi,""),$(this).val(t))}),$(".custokf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣]/gi,""),$(this).val(t))}),$(".custoknf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|0-9]/gi,""),$(this).val(t))}),$(".custoknf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|0-9]/gi,""),$(this).val(t))}),$(".custokuf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣 _]/gi,""),$(this).val(t))}),$(".custokuf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣 _]/gi,""),$(this).val(t))}),$(".custokaef").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z]/gi,""),$(this).val(t))}),$(".custokaef").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z]/gi,""),$(this).val(t))}),$(".custokaenf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9]/gi,""),$(this).val(t))}),$(".custokaenf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9]/gi,""),$(this).val(t))}),$(".custokaendf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9|-]/gi,""),$(this).val(t))}),$(".custokaendf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9|-]/gi,""),$(this).val(t))}),$(".custokaenwf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9|\s]/gi,""),$(this).val(t))}),$(".custokaenwf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9|\s]/gi,""),$(this).val(t))}),$(".custokaenpf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9|()]/gi,""),$(this).val(t))}),$(".custokaenpf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9|()]/gi,""),$(this).val(t))}),$(".custokaenppf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9|() .]/gi,""),$(this).val(t))}),$(".custokaenppf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9|() .]/gi,""),$(this).val(t))}),$(".custokaenpsf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9|() /]/gi,""),$(this).val(t))}),$(".custokaenpsf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9|() /]/gi,""),$(this).val(t))}),$(".custokaenpof").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9| .]/gi,""),$(this).val(t))}),$(".custokaenpof").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^\ㄱ-ㅎㅏ-ㅣ|가-힣|a-zA-Z|0-9| .]/gi,""),$(this).val(t))}),$(".custoensf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^a-zA-Z|0-9| /]/gi,""),$(this).val(t))}),$(".custoensf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^a-zA-Z|0-9| /]/gi,""),$(this).val(t))}),$(".custoenspf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^a-zA-Z|0-9| / .]/gi,""),$(this).val(t))}),$(".custoenspf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^a-zA-Z|0-9| / .]/gi,""),$(this).val(t))}),$(".custoenuf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^a-zA-Z|0-9| _]/gi,""),$(this).val(t))}),$(".custoenuf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^a-zA-Z|0-9| _]/gi,""),$(this).val(t))}),$(".custoenuhf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^a-zA-Z|0-9| _ -]/gi,""),$(this).val(t))}),$(".custoenuhf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^a-zA-Z|0-9| _ -]/gi,""),$(this).val(t))}),$(".custoenf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^a-zA-Z|0-9]/gi,""),$(this).val(t))}),$(".custoenf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[^a-zA-Z|0-9]/gi,""),$(this).val(t))}),$(".custoemf").keyup(function(e){$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||$(this).val($(this).val().replace(/[^a-zA-Z0-9 @ \- .]/g,""))}),$(".custoemf").focusout(function(e){$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||$(this).val($(this).val().replace(/[^a-zA-Z0-9 @ \- .]/g,""))}),$(".custaascf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[~!@#$%^&*()_+|<>?:{}'"` .]/gi,""),$(this).val(t))}),$(".custaascf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[~!@#$%^&*()_+|<>?:{}'"` .]/gi,""),$(this).val(t))}),$(".custttscf").keyup(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[$%^&*+|<>:{}'"`]/gi,""),$(this).val(t))}),$(".custttscf").focusout(function(e){var t=$(this).val();37<=e.keyCode&&e.keyCode<=40&&8!=e.keyCode||(t=t.replace(/[$%^&*+|<>:{}'"`]/gi,""),$(this).val(t))}),$(".caahcpv").keyup(function(e){$(this).val($(this).val().replace(/[^0-9]/g,"").replace(/(^02|^0505|^1[0-9]{3}|^0[0-9]{2})([0-9]+)?([0-9]{4})$/,"$1-$2-$3").replace("--","-"))}),$(".caahcpv").focusout(function(e){$(this).val($(this).val().replace(/[^0-9 -]/g,""))}),$(".caahcbv").keyup(function(e){$(this).val($(this).val().replace(/[^0-9]/g,"").replace(/(\d{3})(\d{2})(\d{5})/,"$1-$2-$3").replace("--","-"))}),$(".caahcbv").focusout(function(e){$(this).val($(this).val().replace(/[^0-9 -]/g,""))}),$(".dropdown-menu").click(function(e){e.stopPropagation()}),$("textarea.autosize").on("keydown keyup",function(){checkValid.isCheckValueVaild($(this).val())&&$(this).height(1).height($(this).prop("scrollHeight")-4)}),$(".dblce").dblclick(function(){$(this).prop("checked",!1)})}$(function(){fn_inputRestriction()});const dynamicTable={createTag:function(e){var t=e[0].substring(0,3),a=e[0].substring(3,5);if("rpc"==t){for(var i=0;i<e.length;i++)fn_getRpcTag(e[i]);void 0!==$("#uploadFileTbody").html()&&(t=$("#projectId").val(),$.ajax({type:"POST",url:"/application/getReportFileList.do",data:{projectId:t,codeId:"file",codeGroup:a},dataType:"json",async:!1,success:function(t){var i,n,l;700==t.statusCode?(i='<option value=""></option>',$.each(t.data.companyList,function(e,t){i+='<option value="'+t.companyId+'">'+t.companyName+"</option>"}),n='<tr><th class="custThTd custTh">구분</th><th class="custThTd custTh">기관</th><th class="custThTd custTh">첨부파일</th><th class="custThTd custTh">버전</th></tr>',l=0,$.each(t.data.reportList,function(e,a){$.each(t.data.companyList,function(e,t){n+="<tr>",n+='<td class="custThTd">',n+='<input type="hidden" name="reportDocCd'+l+'" value="'+a.code+'" />',n+='<input type="hidden" name="reportDocNm'+l+'" value="'+a.data+'" />',n+=a.data,n+="</td>",n+='<td class="custThTd">',n+='<select class="form-control" name="reportCompanyId'+l+'">',n+=i,n+="</select>",n+="</td>",n+='<td class="custThTd">',n+='<input type="file" name="reportFile@'+l+'" />',n+="</td>",n+='<td class="custThTd">',n+='<input type="text" name="reportFileVersion'+l+'" class="form-control custonpf" maxlength="15" />',n+="</td>",n+="</tr>",l++})}),n+='<iframe width=0 height=0 name="hiddenFrame" style="display:none;"></iframe>',$("#uploadFileTbody").empty(),$("#uploadFileTbody").html(n)):console.log(t.statusCode)},error:function(e,t,a){alert("status: "+e.status+", error: "+a)}}),setTimeout(function(){fn_ppcEvent1()},100),setTimeout(function(){fn_search1()},500),setTimeout(function(){fn_textareaManualResize()},600))}else{for(i=0;i<e.length;i++)fn_getPpcTag(e[i]);"01"==a?setTimeout(function(){fn_ppcEvent1()},100):setTimeout(function(){fn_ppcEvent2()},100),setTimeout(function(){fn_search1()},200),setTimeout(function(){fn_textareaManualResize()},500)}},autoWidthSize:function(){var e=screen.width/2-500;e+="px",$(".autoWidthSize").css("max-width",e),$(".autoWidthSize").css("text-overflow","ellipsis"),$(".autoWidthSize").css("overflow","hidden"),$(".autoWidthSize").hover(function(){var i=$(this).html();-1!=i.indexOf("<a")?(i="",$($(this).children()).each(function(e,t){var a=(a=$(this).html()).replace(/&nbsp;/g," ").replace(/<br>/g,"").replace(/\n\r/g,"").replace(/\n/g,"").replace(/\r/g,"").trim();i+=a})):-1!=i.indexOf("<span")&&$($(this).children()).each(function(e,t){var a=(a=$(this).html()).replace(/&nbsp;/g," ").replace(/<br>/g,"").replace(/\n\r/g,"").replace(/\n/g,"").replace(/\r/g,"").trim();i+=a}),$(this).attr("title",i)}),$(".autoWidthSize").tooltip()}};function fn_getPpcTag(i){var e=i.substring(3,5),t=i.substring(5,7);$.ajax({type:"POST",url:"/application/getPpcdForCreateTag.do",data:{groupGbn:e,codeGroup:t},async:!1,dataType:"json",success:function(e){var n,t,a;700==e.statusCode?(a=n="","radio"==(t=e.data[0].inputType)?(n=e.data[0].ppcdPrefix+'<div class="form-group d-inline">',$.each(e.data,function(e,t){n+='<div class="radio d-inline">',n+='<input type="radio" name="'+t.tagName+'" id="'+t.tagName+e+'" ondblclick="if(this.checked == true){this.checked = false;}" value="'+t.code+'" />',n+='<label for="'+t.tagName+e+'" class="cr">'+t.data+"</label>",n+="</div>","Y"==t.subYn&&(e=t.groupGbn,t=t.subCodeGroup,n+=fn_getPpcSubTag(e,t))}),a="</div>"+e.data[0].ppcdSuffix):"checkbox"==t?(n=e.data[0].ppcdPrefix+'<div class="form-group d-inline">',$.each(e.data,function(e,t){var a;a=e,n+='<div class="checkbox checkbox-fill d-inline">',n+='<input type="checkbox" name="'+t.tagName+'" id="'+t.tagName+a+'" ondblclick="if(this.checked == true){this.checked = false;}" value="'+t.code+'" />',n+='<label for="'+t.tagName+a+'" class="cr">'+t.data+"</label>",n+="</div>","Y"==t.subYn&&(e=t.groupGbn,t=t.subCodeGroup,n+=fn_getPpcSubTag(e,t)),8==a&&(n+="<br />")}),a="</div>"+e.data[0].ppcdSuffix):"select"==t?(n=e.data[0].ppcdPrefix+'<select class="form-control" name="'+e.data[0].tagName+'"',"ppc0111"==e.data[0].tagName&&(n+=' disabled="disabled"'),n+='><option value=""></option>',$.each(e.data,function(e,t){n+='<option value="'+t.code+'">'+t.data+"</option>"}),a="</select>"+e.data[0].ppcdSuffix):(n=e.data[0].ppcdPrefix,a=e.data[0].ppcdSuffix,"text"==t?$.each(e.data,function(e,t){n+='<input type="text" name="'+t.tagName+'" class="form-control '+t.inputRestriction+'" maxlength="'+t.lengthRestriction+'" />'}):"textarea"==t?$.each(e.data,function(e,t){n+='<textarea name="'+t.tagName+'" class="form-control autosize '+t.inputRestriction+'" style="resize: none;"></textarea>'}):"calendar"==t||("smallText"==t?"ppc0135"==e.data[0].tagName?$.each(e.data,function(e,t){var a;n+='<input type="text" name="'+t.tagName+'" class="ppc013s '+t.inputRestriction+'" maxlength="'+t.lengthRestriction+'" style="width: 100px; height: 20px;" />',"Y"==t.subYn&&(a=t.groupGbn,t=t.subCodeGroup,n+=fn_getPpcSubTag(a,t))}):$.each(e.data,function(e,t){var a;n+='<input type="text" name="'+t.tagName+'" class="'+t.inputRestriction+'" maxlength="'+t.lengthRestriction+'" style="width: 100px; height: 20px;" />',"Y"==t.subYn&&(a=t.groupGbn,t=t.subCodeGroup,n+=fn_getPpcSubTag(a,t))}):"smallCalendar"==t&&$.each(e.data,function(e,t){var a;n+='&nbsp;<input type="text" class="custCalendar" name="'+t.tagName+'" placehold="date" style="width:120px;" />&nbsp;&nbsp;',"Y"==t.subYn&&(a=t.groupGbn,t=t.subCodeGroup,n+=fn_getPpcSubTag(a,t))}))),n+=a,"ppc0135"==i&&(a=$("#projectId").val(),$.ajax({type:"POST",url:"/application/getJoinCompanyPart1.do",data:{projectId:a},async:!1,dataType:"json",success:function(e){var a,i;700==e.statusCode?(a=n,n=i="",$.each(e.data,function(e,t){i=a,n+=t.companyName+" : ",i=(i=(i=i.replace(/ppc0135/gi,"ppc0135_"+t.companyId)).replace(/ppc0136/gi,"ppc0136_"+t.companyId)).replace(/ppc0137/gi,"ppc0137_"+t.companyId),n+=i,n+="<br />"})):console.log(e.statusCode)},error:function(e,t,a){alert("status: "+e.status+", error: "+a)}})),$("#"+i+"Td").empty(),$("#"+i+"Td").html(n)):console.log(e.statusCode)},error:function(e,t,a){alert("status: "+e.status+", error: "+a)}})}function fn_ppcEvent1(){$("select[name='ppc0110']").change(function(){"01"==$(this).val()?$("select[name='ppc0111']").removeAttr("disabled"):($("select[name='ppc0111'] option:eq(0)").prop("selected",!0),$("select[name='ppc0111']").attr("disabled",!0))}),$("input[name='ppc0112']").change(function(){"01"==$(this).val()?($("input[name='ppc0133']").removeAttr("disabled"),$("input[name='ppc0134']").attr("disabled",!0),$("input[name='ppc0134']").val("")):($("input[name='ppc0134']").removeAttr("disabled"),$("input[name='ppc0133']").attr("disabled",!0),$("input[name='ppc0133']").val(""))}),$("input[name='ppc0102']").change(function(){"01"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0130']").removeAttr("disabled"):($("input[name='ppc0130']").attr("disabled",!0),$("input[name='ppc0130']").prop("checked",!1)))}),$("input[name='ppc0103']").change(function(){"01"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0131']").removeAttr("disabled"):($("input[name='ppc0131']").attr("disabled",!0),$("input[name='ppc0131']").prop("checked",!1)))}),$("input[name='ppc0115']").change(function(){"01"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0132']").removeAttr("disabled"):($("input[name='ppc0132']").attr("disabled",!0),$("input[name='ppc0132']").prop("checked",!1)))}),$("input[name='ppc0124']").change(function(){"05"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0138']").removeAttr("disabled"):($("input[name='ppc0138']").attr("disabled",!0),$("input[name='ppc0138']").val("")))}),$("input[name='ppc0125']").change(function(){"04"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0139']").removeAttr("disabled"):($("input[name='ppc0139']").attr("disabled",!0),$("input[name='ppc0139']").val("")))}),$("input[name='rpc0201']").change(function(){"08"==$(this).val()&&($(this).is(":checked")?$("input[name='rpc0206']").removeAttr("disabled"):($("input[name='rpc0206']").attr("disabled",!0),$("input[name='rpc0206']").val("")))}),$(".custCalendar").bootstrapMaterialDatePicker({weekStart:0,lang:"ko",time:!1}),fn_inputRestriction()}function fn_ppcEvent2(){$("input[name='ppc0203']").change(function(){"03"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0229']").removeAttr("disabled"):($("input[name='ppc0229']").attr("disabled",!0),$("input[name='ppc0229']").val("")))}),$("input[name='ppc0212']").change(function(){"02"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0230']").removeAttr("disabled"):($("input[name='ppc0230']").attr("disabled",!0),$("input[name='ppc0230']").prop("checked",!1))),"05"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0231']").removeAttr("disabled"):($("input[name='ppc0231']").attr("disabled",!0),$("input[name='ppc0231']").val("")))}),$("input[name='ppc0214']").change(function(){"13"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0232']").removeAttr("disabled"):($("input[name='ppc0232']").attr("disabled",!0),$("input[name='ppc0232']").val("")))}),$("input[name='ppc0218']").change(function(){"05"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0233']").removeAttr("disabled"):($("input[name='ppc0233']").attr("disabled",!0),$("input[name='ppc0233']").val("")))}),$("input[name='ppc0219']").change(function(){"03"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0234']").removeAttr("disabled"):($("input[name='ppc0234']").attr("disabled",!0),$("input[name='ppc0234']").val("")))}),$("input[name='ppc0220']").change(function(){"03"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0235']").removeAttr("disabled"):($("input[name='ppc0235']").attr("disabled",!0),$("input[name='ppc0235']").val("")))}),$("input[name='ppc0224']").change(function(){"03"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0236']").removeAttr("disabled"):($("input[name='ppc0236']").attr("disabled",!0),$("input[name='ppc0236']").val("")))}),$("input[name='ppc0225']").change(function(){"04"==$(this).val()&&($(this).is(":checked")?$("input[name='ppc0237']").removeAttr("disabled"):($("input[name='ppc0237']").attr("disabled",!0),$("input[name='ppc0237']").val("")))}),$(".custCalendar").bootstrapMaterialDatePicker({weekStart:0,lang:"ko",time:!1}),fn_inputRestriction()}function fn_getPpcSubTag(e,t){var i="";return $.ajax({type:"POST",url:"/application/getPpcdForCreateTag.do",data:{groupGbn:e,codeGroup:t},async:!1,dataType:"json",success:function(e){700==e.status?"radio"==e.data[0].inputType?(i=e.data[0].ppcdPrefix,$.each(e.data,function(e,t){i+='<div class="radio d-inline">',i+='<input type="radio" name="'+t.tagName+'" id="'+t.tagName+e+'" ondblclick="if(this.checked == true){this.checked = false;}" value="'+t.code+'"  disabled="disabled" />',i+='<label for="'+t.tagName+e+'" class="cr">'+t.data+"</label>",i+="</div>"}),i+=e.data[0].ppcdSuffix):"smallText"==e.data[0].inputType?(i+=e.data[0].ppcdPrefix,$.each(e.data,function(e,t){var a;i+='<input type="text" name="'+t.tagName+'" class="'+t.inputRestriction+'" maxlength="'+t.lengthRestriction+'" style="width: 100px; height: 20px;"',"ppc0136"!=t.tagName&&"ppc0137"!=t.tagName&&(i+=' disabled="disabled"'),i+="/>","Y"==t.subYn&&(a=t.groupGbn,t=t.subCodeGroup,i+=fn_getPpcSubTag(a,t))}),i+=e.data[0].ppcdSuffix):"smallCalendar"==e.data[0].inputType?(i+=e.data[0].ppcdPrefix,$.each(e.data,function(e,t){var a;i+='&nbsp;<input type="text" class="custCalendar" name="'+t.tagName+'" placehold="date" style="width:120px;" />',"Y"==t.subYn&&(a=t.groupGbn,t=t.subCodeGroup,i+=fn_getPpcSubTag(a,t))}),i+=e.data[0].ppcdSuffix):"checkbox"==e.data[0].inputType&&(i=e.data[0].ppcdPrefix,$.each(e.data,function(e,t){i+='<div class="checkbox checkbox-fill d-inline">',i+='<input type="checkbox" name="'+t.tagName+'" id="'+t.tagName+e+'" ondblclick="if(this.checked == true){this.checked = false;}" value="'+t.code+'" disabled="disabled" />',i+='<label for="'+t.tagName+e+'" class="cr">'+t.data+"</label>",i+="</div>"}),i+=e.data[0].ppcdSuffix):console.log(e.status)},error:function(e,t,a){alert("status: "+e.status+", error: "+a)}}),i}function fn_ppc0135sValid(){var i=!0;return $(".ppc013s").each(function(e,t){var a=$(this).val();if(void 0===a||null==a||""==a)return i=!1}),i}function fn_textareaManualResize(){$("textarea.autosize").each(function(e,t){checkValid.isCheckValueVaild($(this).val())&&$(this).height(1).height($(this).prop("scrollHeight")-4)})}function fn_getRpcTag(i){var e=i.substring(3,5),t=i.substring(5,7);$.ajax({type:"POST",url:"/application/getRpcdForCreateTag.do",data:{groupGbn:e,codeGroup:t},async:!1,dataType:"json",success:function(e){var n,t,a;700==e.statusCode?(t=n="","radio"==(a=e.data[0].inputType)?(n=e.data[0].ppcdPrefix+'<div class="form-group d-inline">',$.each(e.data,function(e,t){n+='<div class="radio d-inline">',n+='<input type="radio" name="'+t.tagName+'" id="'+t.tagName+e+'" ondblclick="if(this.checked == true){this.checked = false;}" value="'+t.code+'" />',n+='<label for="'+t.tagName+e+'" class="cr">'+t.data+"</label>",n+="</div>","Y"==t.etcDesc&&(n+="<br />"),"Y"==t.subYn&&(e=t.groupGbn,t=t.subCodeGroup,n+=fn_getRpcSubTag(e,t))}),t="</div>"+e.data[0].ppcdSuffix):"checkbox"==a?(n=e.data[0].ppcdPrefix+'<div class="form-group d-inline">',$.each(e.data,function(e,t){var a,i;a=e,n+='<div class="checkbox checkbox-fill d-inline">',n+='<input type="checkbox" name="'+t.tagName+'" id="'+t.tagName+a+'" ondblclick="if(this.checked == true){this.checked = false;}" value="'+t.code+'" />',n+='<label for="'+t.tagName+a+'" class="cr">'+t.data+"</label>",n+="</div>","Y"==t.etcDesc&&(n+="<br />"),"Y"==t.subYn&&(i=t.groupGbn,e=t.subCodeGroup,n+=fn_getRpcSubTag(i,e)),"Y"!=t.etcDesc&&8==a&&(n+="<br />")}),t="</div>"+e.data[0].ppcdSuffix):"select"==a?(n=e.data[0].ppcdPrefix+'<select class="form-control" name="'+e.data[0].tagName+'"',"ppc0111"==e.data[0].tagName&&(n+=' disabled="disabled"'),n+='><option value=""></option>',$.each(e.data,function(e,t){n+='<option value="'+t.code+'">'+t.data+"</option>"}),t="</select>"+e.data[0].ppcdSuffix):(n=e.data[0].ppcdPrefix,t=e.data[0].ppcdSuffix,"text"==a?$.each(e.data,function(e,t){n+='<input type="text" name="'+t.tagName+'" class="form-control '+t.inputRestriction+'" maxlength="'+t.lengthRestriction+'" />'}):"textarea"==a?$.each(e.data,function(e,t){n+='<textarea name="'+t.tagName+'" class="form-control autosize '+t.inputRestriction+'" style="resize: none;"></textarea>'}):"calendar"==a||("smallText"==a?$.each(e.data,function(e,t){var a;n+='<input type="text" name="'+t.tagName+'" class="'+t.inputRestriction+'" maxlength="'+t.lengthRestriction+'" style="width: 100px; height: 20px;" />',"Y"==t.subYn&&(a=t.groupGbn,t=t.subCodeGroup,n+=fn_getRpcSubTag(a,t))}):"smallCalendar"==a&&$.each(e.data,function(e,t){var a;n+='&nbsp;<input type="text" class="custCalendar" name="'+t.tagName+'" placehold="date" style="width:120px;" />&nbsp;&nbsp;',"Y"==t.subYn&&(a=t.groupGbn,t=t.subCodeGroup,n+=fn_getRpcSubTag(a,t))}))),n+=t,$("#"+i+"Td").empty(),$("#"+i+"Td").html(n)):console.log(e.statusCode)},error:function(e,t,a){alert("status: "+e.status+", error: "+a)}})}function fn_getRpcSubTag(e,t){var i="";return $.ajax({type:"POST",url:"/application/getRpcdForCreateTag.do",data:{groupGbn:e,codeGroup:t},async:!1,dataType:"json",success:function(e){700==e.status?"radio"==e.data[0].inputType?(i=e.data[0].ppcdPrefix,$.each(e.data,function(e,t){i+='<div class="radio d-inline">',i+='<input type="radio" name="'+t.tagName+'" id="'+t.tagName+e+'" ondblclick="if(this.checked == true){this.checked = false;}" value="'+t.code+'"  disabled="disabled" />',i+='<label for="'+t.tagName+e+'" class="cr">'+t.data+"</label>",i+="</div>","Y"==t.etcDesc&&(i+="<br />")}),i+=e.data[0].ppcdSuffix):"smallText"==e.data[0].inputType?(i+=e.data[0].ppcdPrefix,$.each(e.data,function(e,t){var a;i+='<input type="text" name="'+t.tagName+'" class="'+t.inputRestriction+'" maxlength="'+t.lengthRestriction+'" style="width: 100px; height: 20px;"',"ppc0136"!=t.tagName&&"ppc0137"!=t.tagName&&(i+=' disabled="disabled"'),i+="/>","Y"==t.subYn&&(a=t.groupGbn,t=t.subCodeGroup,i+=fn_getRpcSubTag(a,t))}),i+=e.data[0].ppcdSuffix):"smallCalendar"==e.data[0].inputType?(i+=e.data[0].ppcdPrefix,$.each(e.data,function(e,t){var a;i+='&nbsp;<input type="text" class="custCalendar" name="'+t.tagName+'" placehold="date" style="width:120px;" />',"Y"==t.subYn&&(a=t.groupGbn,t=t.subCodeGroup,i+=fn_getRpcSubTag(a,t))}),i+=e.data[0].ppcdSuffix):"checkbox"==e.data[0].inputType?(i=e.data[0].ppcdPrefix,$.each(e.data,function(e,t){i+='<div class="checkbox checkbox-fill d-inline">',i+='<input type="checkbox" name="'+t.tagName+'" id="'+t.tagName+e+'" ondblclick="if(this.checked == true){this.checked = false;}" value="'+t.code+'" disabled="disabled" />',i+='<label for="'+t.tagName+e+'" class="cr">'+t.data+"</label>",i+="</div>","Y"==t.etcDesc&&(i+="<br />")}),i+=e.data[0].ppcdSuffix):"html"==e.data[0].inputType&&(i=e.data[0].custHtml):console.log(e.status)},error:function(e,t,a){alert("status: "+e.status+", error: "+a)}}),i}const checkBoxValid={isAllCheckForName:function(e){var t=!0,a=0,i=0;return $("input:checkbox[name='"+e+"']").each(function(e,t){a++,$(this).is(":checked")&&i++}),a!=i&&(t=!1),t},isRadioChecked:function(e){var a=0;return $("input:radio[name='"+e+"']").each(function(e,t){$(this).is(":checked")&&a++}),0!=a},isCheckBoxChecked:function(e){var a=0;return $("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")&&a++}),0!=a},getRadioValue:function(e){return $("input:radio[name='"+e+"']:checked").val()}},printUtils={print:function(){$("#printRemoveDiv").empty(),window.print();$("#printRemoveDiv").html('<h5>인쇄미리보기</h5><div class="card-header-right"><div class="btn-group card-option"><button type="button" class="btn btn-primary btn-sm" onclick="printUtils.print()" style="margin-right:5px;">인쇄</button><button type="button" class="btn btn-primary btn-sm" onclick="printUtils.convertPdf(location.href)" style="margin-right:0px;">PDF 변환</button></div></div>')},convertPdf:function(e){$("#dummy0101").empty(),$("#dummy0101").html('<iframe width="0px;" height="0px;" name="receiptHiddenFrame" style="display:none;"></iframe>');var t=$("#projectId").val(),a=$("#reportId").val(),i=$("#reportState").val(),n=$("#reportGbn").val(),l=$("#memberId").val(),c=$("#meetingId").val(),o=$("#irbId").val(),s=$("#agendaId").val(),u=$("#agendaWriteGbn").val(),r=$("#meetingDocumentId").val(),d=$("#meetingDocumentWriteGbn").val();fn_isCheckNumValueVaild(t)&&""!=t||(t=""),fn_isCheckNumValueVaild(a)&&""!=a||(a=""),fn_isCheckNumValueVaild(i)&&""!=i||(i=""),fn_isCheckNumValueVaild(n)&&""!=n||(n=""),fn_isCheckNumValueVaild(l)&&""!=l||(l=""),fn_isCheckNumValueVaild(c)&&""!=c||(c=""),fn_isCheckNumValueVaild(o)&&""!=o||(o=""),fn_isCheckNumValueVaild(s)&&""!=s||(s=""),fn_isCheckNumValueVaild(u)&&""!=u||(u=""),fn_isCheckNumValueVaild(r)&&""!=r||(r=""),fn_isCheckNumValueVaild(d)&&""!=d||(d=""),window.open("/getConvertPdf.do?projectId="+t+"&reportId="+a+"&reportState="+i+"&reportGbn="+n+"&memberId="+l+"&meetingId="+c+"&irbId="+o+"&agendaId="+s+"&agendaWriteGbn="+u+"&meetingDocumentId="+r+"&meetingDocumentWriteGbn="+d+"&targetUrl="+e,"receiptHiddenFrame")},print2:function(e){$("#printRemoveDiv").empty(),window.print();var t='<h5>인쇄미리보기</h5><div class="card-header-right"><div class="btn-group card-option"><button type="button" class="btn btn-primary btn-sm" onclick="printUtils.print2(\''+e+'\')" style="margin-right:5px;">인쇄</button><button type="button" class="btn btn-primary btn-sm" onclick="printUtils.convertPdf(location.href)" style="margin-right:5px;">PDF 변환</button><button type="button" class="btn btn-primary btn-sm" onclick="fn_getFileList()" style="margin-right:0px;">첨부파일</button>';"04"==e&&(t+='<button type="button" class="btn btn-dark btn-sm" onclick="fn_withdraw()" style="margin-left:5px;">회수</button>'),t+="</div></div>",$("#printRemoveDiv").html(t)}},fileUtils={downloadFile:function(e){$("#dummy0101").empty(),$("#dummy0101").html('<iframe width="0px;" height="0px;" name="receiptHiddenFrame" style="display:none;"></iframe>'),window.open("/application/getReportFileDownload.do?fileId="+e,"receiptHiddenFrame")},downloadZipFile:function(){$("#dummy0101").empty(),$("#dummy0101").html('<iframe width="0px;" height="0px;" name="receiptHiddenFrame" style="display:none;"></iframe>');var e=fn_getInputNameValue("fileNames"),t=$("#projectId").val(),a=$("#reportId").val();window.open("/getZipFile.do?fileNames="+e+"&projectId="+t+"&reportId="+a,"receiptHiddenFrame")},inputFileInit:function(){var e=navigator.userAgent.toLowerCase();"Netscape"==navigator.appName&&-1!=navigator.userAgent.search("Trident")||-1!=e.indexOf("msie")?":file".replaceWith(":file".clone(!0)):$(":file").val("")},submitFrm:function(a,e){return $.each(e.split(","),function(e,t){a.append(t,$("#"+t).val())}),a}},checkValid={isCheckValueVaild:function(e){return void 0!==e&&null!=e&&""!=e},isAllCheckForName:function(e){var t=!0,a=0,i=0;return $("input:checkbox[name='"+e+"']").each(function(e,t){a++,$(this).is(":checked")&&i++}),a!=i&&(t=!1),t},isRadioChecked:function(e){var a=0;return $("input:radio[name='"+e+"']").each(function(e,t){$(this).is(":checked")&&a++}),0!=a},isCheckBoxChecked:function(e){var a=0;return $("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")&&a++}),0!=a},isEmailValid:function(e){if(!checkValid.isCheckValueVaild(e))return console.log("이메일 값이 유효하지 않음"),!1;return null!=e.match(/^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]{2,3}$/i)||(console.log("이메일 형식에 맞게 입력해주세요."),!1)},inputPhoneNumber:function(e){var t=e.value.replace(/[^0-9]/g,""),a="";if(t.length<4)return t;t.length<7?(a+=t.substr(0,3),a+="-",a+=t.substr(3)):t.length<11?(a+=t.substr(0,3),a+="-",a+=t.substr(3,3),a+="-",a+=t.substr(6)):(a+=t.substr(0,3),a+="-",a+=t.substr(3,4),a+="-",a+=t.substr(7)),e.value=a},isMobileValid:function(e){return!!/^(01[016789]{1}|02|0[3-9]{1}[0-9]{1})-?[0-9]{3,4}-?[0-9]{4}$/.test(e)||(console.log("전화번호(휴대폰) 유효하지 않음."),!1)},isTelValid:function(e){var t=new String(e);if(8!=(t=t.replace(/-/gi,"")).length){console.log(t.length);if(!/^(01[016789]{1}|02|0[3-9]{1}[0-9]{1})-?[0-9]{3,4}-?[0-9]{4}$/.test(e))return console.log("전화번호(휴대폰) 유효하지 않음."),!1}return!0},checkAll:function(e,t){$("#"+e).is(":checked")?$("input:checkbox[name='"+t+"']").each(function(e,t){0==$(this).is(":disabled")&&0==$(this).is(":checked")&&$(this).click()}):$("input:checkbox[name='"+t+"']").each(function(e,t){$(this).is(":checked")&&$(this).click()})},checkboxDisabledSettingForClass:function(e){$("."+e).click(function(e){var t=$(this).attr("id");$(this).is(":checked")?$("input:checkbox[name='"+t+"']").each(function(e,t){$(t).attr("disabled",!1)}):$("input:checkbox[name='"+t+"']").each(function(e,t){$(t).is(":checked")&&$(t).click(),$(t).attr("disabled",!0)})})}},getValue={getRadioValue:function(e){return $("input:radio[name='"+e+"']:checked").val()},randomString:function(){for(var e="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz",t="",a=0;a<15;a++){var i=Math.floor(Math.random()*e.length);t+=e.substring(i,i+1)}return t},getCheckBoxValueYn:function(e){var a="";return $("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")&&0==$(this).is(":disabled")?a+="Y,":a+="N,"}),0!=a.length&&(a=a.substring(0,a.length-1)),a},getCheckBoxValueForName:function(e,t){var a="";return fn_isCheckNumValueVaild(t)&&""!=t?1==t?$("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}):2==t?$("input:checkbox[name='"+e+"']").each(function(e,t){a+=$(this).val()+","}):3==t?$("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")&&(a+=$(this).val()+",")}):$("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}):$("input:checkbox[name='"+e+"']").each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}),0!=a.length&&(a=a.substring(0,a.length-1)),a},getCheckBoxValueForClass:function(e,t){var a="";return fn_isCheckNumValueVaild(t)&&""!=t?1==t?$("."+e).each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}):2==t?$("."+e).each(function(e,t){a+=$(this).val()+","}):3==t?$("."+e).each(function(e,t){$(this).is(":checked")&&(a+=$(this).val()+",")}):$("."+e).each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}):$("."+e).each(function(e,t){$(this).is(":checked")?a+=$(this).val()+",":a+=","}),0!=a.length&&(a=a.substring(0,a.length-1)),a},getInputNameValue:function(e){var a="";return $("input[name='"+e+"']").each(function(e,t){a+=$(this).val()+","}),0!=a.length&&(a=a.substring(0,a.length-1)),a},getTdNameHtml:function(e){var a="";return $("td[name='"+e+"']").each(function(e,t){a+=$(this).html()+","}),0!=a.length&&(a=a.substring(0,a.length-1)),a}},dynamicSubmit={createFormSubmit:function(e,t,a,i,n,l){var c=document.createElement("form"),o=document.createElement("input");if(c.setAttribute("method",t),c.setAttribute("action",e),fn_isCheckValueVaild(a)&&c.setAttribute("target",a),fn_isCheckNumValueVaild(l)&&1!=l)for(var s=i.split(","),u=n.split(","),r=0;r<l;r++)s[r]&&((o=document.createElement("input")).type="hidden",o.name=s[r],o.value=fn_changeText(u[r]),c.appendChild(o));else fn_isCheckValueVaild(i)&&(o.type="hidden",o.name=i,o.value=n,c.appendChild(o));document.body.appendChild(c),c.submit()},cPopup:function(e,t,a,i,n,l){fn_isCheckNumValueVaild(n)||""!=n||(n=680),fn_isCheckNumValueVaild(l)||""!=l||(l=570);var c,o=(screen.width-n)/2,s=(screen.height-l)/2,u=getValue.randomString();return fn_isCheckValueVaild(t)?(c=window.open("",u,"width="+n+",height="+l+",top="+s+",left="+o+", scrollbars=no"),fn_createFormSubmit(e,"post",u,t,a,i)):c=window.open(e,u,"width="+n+",height="+l+",top="+s+",left="+o+", scrollbars=no"),c&&c.focus(),c}};